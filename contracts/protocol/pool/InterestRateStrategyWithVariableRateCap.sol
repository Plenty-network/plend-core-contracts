...
import {IInterestRateStrategyWithVariableRateCap} from '../../interfaces/IInterestRateStrategyWithVariableRateCap.sol';
import {IReserveInterestRateStrategy} from '../../interfaces/IReserveInterestRateStrategy.sol';
import {IPoolAddressesProvider} from '../../interfaces/IPoolAddressesProvider.sol';
import {IACLManager} from '../../interfaces/IACLManager.sol';

/**
 * @title InterestRateStrategyWithVariableRateCap contract
 * @author Aave
 ...
 * - This interest rate strategy places a cap on variable borrow rate.
 */
contract InterestRateStrategyWithVariableRateCap is IInterestRateStrategyWithVariableRateCap {
  using WadRayMath for uint256;
  using PercentageMath for uint256;

  /// @inheritdoc IInterestRateStrategyWithVariableRateCap
  ...
  /// @inheritdoc IInterestRateStrategyWithVariableRateCap
  uint256 public immutable MAX_VARIABLE_BORROW_RATE;
  ...
  constructor(
    ...
    MAX_VARIABLE_BORROW_RATE = maxVariableBorrowRate;
  ...
  function getMaxVariableBorrowRate() external view override returns (uint256) {
    return MAX_VARIABLE_BORROW_RATE;
  }
